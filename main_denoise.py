...
def main(args):
    ...
    # save models
    torch.save(model.state_dict(), f"denoise_model3{args.noise_level}.pt")
    torch.save(model_reg.state_dict(), f"denoise_model_reg3{args.noise_level}.pt")
    ...
    with open(f"denoise_results3{args.noise_level}.pkl", "wb") as f:
